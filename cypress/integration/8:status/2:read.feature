...
Feature: READ: Status
  ...
  Scenario: Read statuses on grid - success
    ...
    * On "grid" I can see row with "status_code" value and columns data: "{'0': 'status_code', '2': '', '3': ''}"
    * On "grid" I can see row with "status_code2" value and columns data: "{'0': 'status_code2', '2': '', '3': ''}"
