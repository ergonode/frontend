...
export default {
    ...
    mixins: [
        extendPropsMixin({
            extendedKey: '@Attributes/components/Grids/AttributesGrid/props',
            extendedNames: [
                'grid',
            ],
        }),
    ...
    computed: {
        extendedActionHeader() {
            return this.$getExtendSlot('@Attributes/components/Grids/AttributesGrid/actionHeader');
        },
        extendedFooter() {
            return this.$getExtendSlot('@Attributes/components/Grids/AttributesGrid/footer');
        },
        isAllowedToUpdate() {
