...
export default {
    ...
    async getProductDraft({
        ...
        try {
            ...
            await this.$getExtendMethod('@Products/store/product/action/getProductDraft/__before', {
                $this: this,
                data: {
                    id,
                },
            ...
            await this.$getExtendMethod('@Products/store/product/action/getProductDraft/__after', {
                $this: this,
                data: {
                    attributes,
                },
