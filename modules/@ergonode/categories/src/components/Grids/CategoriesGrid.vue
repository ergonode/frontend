...
export default {
    ...
    mixins: [
        extendPropsMixin({
            extendedKey: '@Categories/components/Grids/CategoriesGrid/props',
            extendedNames: [
                'grid',
            ],
        }),
    ...
    computed: {
        extendedActionHeader() {
            return this.$getExtendSlot('@Categories/components/Grids/CategoriesGrid/actionHeader');
        },
        extendedFooter() {
            return this.$getExtendSlot('@Categories/components/Grids/CategoriesGrid/footer');
        },
        isAllowedToUpdate() {
    ...
    methods: {
        ...
        onRemoveRow() {
            this.$addAlert({
                ...
                message: this.$t('@Categories.category.components.CategoriesGrid.deleteSuccess'),
            });
            this.onFetchData();
        },
        onEditRow(args) {
