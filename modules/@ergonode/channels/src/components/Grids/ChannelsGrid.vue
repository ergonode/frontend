...
export default {
    ...
    mixins: [
        extendPropsMixin({
            extendedKey: '@Channels/components/Grids/ChannelsGrid/props',
            extendedNames: [
                'grid',
            ],
        }),
    ...
    computed: {
        extendedActionHeader() {
            return this.$getExtendSlot('@Channels/components/Grids/ChannelsGrid/actionHeader');
        },
        extendedFooter() {
            return this.$getExtendSlot('@Channels/components/Grids/ChannelsGrid/footer');
        },
        isAllowedToUpdate() {
