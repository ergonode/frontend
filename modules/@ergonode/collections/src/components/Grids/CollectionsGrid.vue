...
export default {
    ...
    mixins: [
        extendPropsMixin({
            extendedKey: '@Collections/components/Grids/CollectionsGrid/props',
            extendedNames: [
                'grid',
            ],
        }),
    ...
    computed: {
        extendedActionHeader() {
            return this.$getExtendSlot('@Collections/components/Grids/CollectionsGrid/actionHeader');
        },
        extendedFooter() {
            return this.$getExtendSlot('@Collections/components/Grids/CollectionsGrid/footer');
        },
        isAllowedToUpdate() {
