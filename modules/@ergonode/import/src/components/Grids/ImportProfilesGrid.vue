...
export default {
    ...
    mixins: [
        extendPropsMixin({
            extendedKey: '@Import/components/Grids/ImportProfilesGrid/props',
            extendedNames: [
                'grid',
            ],
        }),
    ...
    computed: {
        extendedActionHeader() {
            return this.$getExtendSlot('@Import/components/Grids/ImportProfilesGrid/actionHeader');
        },
        extendedFooter() {
            return this.$getExtendSlot('@Import/components/Grids/ImportProfilesGrid/footer');
        },
        isAllowedToUpdate() {
