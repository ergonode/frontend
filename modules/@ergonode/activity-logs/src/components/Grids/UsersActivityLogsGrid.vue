...
export default {
    ...
    computed: {
        extendedActionHeader() {
            return this.$getExtendSlot('@ActivityLogs/components/Grids/UsersActivityLogsGrid/actionHeader');
        },
        extendedFooter() {
            return this.$getExtendSlot('@ActivityLogs/components/Grids/UsersActivityLogsGrid/footer');
        },
        isAllowedToUpdate() {
