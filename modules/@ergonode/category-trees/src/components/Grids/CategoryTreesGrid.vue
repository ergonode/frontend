...
export default {
    ...
    mounted() {
        document.documentElement.addEventListener('category-tree-created', this.onCategoryTreeCreated);
    },
    beforeDestroy() {
        document.documentElement.removeEventListener('category-tree-created', this.onCategoryTreeCreated);
    },
    methods: {
