...
<template>
    <Page>
        <TitleBar
            :title="$t('@Statuses.productStatus._.title')"
...
export default {
    ...
    computed: {
        extendedMainAction() {
            return this.$getExtendSlot('@Statuses/pages/product-statues/mainAction');
        },
        isReadOnly() {
    ...
    head() {
        return {
            title: this.$t('@Statuses.productStatus._.headTitle'),
        };
    },
};
</script>
