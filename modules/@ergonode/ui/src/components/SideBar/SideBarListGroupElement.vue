    ...
    computed: {
        classes() {
            return [
                ...
                {
                    'side-bar-list-group-element--selected': this.isSelected,
                    'side-bar-list-group-element--hovered': this.isHovered,
                    'side-bar-list-group-element--expanded': this.isExpanded,
                },
            ];
        },
        isSelected() {
