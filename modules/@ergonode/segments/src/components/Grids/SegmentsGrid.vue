...
export default {
    ...
    mounted() {
        document.documentElement.addEventListener('segment-created', this.onSegmentCreated);
    },
    beforeDestroy() {
        document.documentElement.removeEventListener('segment-created', this.onSegmentCreated);
    },
    methods: {
        onSegmentCreated() {
            this.onFetchData();
