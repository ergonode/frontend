...
export default {
    ...
    computed: {
        ...
        typeComponent() {
            const extendedParameters = this.$getExtendSlot('@Workflow/components/ConditionSetTreeDesigner/ConditionSetTreeDesignerItemParameter');
            ...
            return () => import(`@Workflow/components/ConditionSetTreeDesigner/ItemParameters/${componentName}`)
                .catch(() => import('@Workflow/components/ConditionSetTreeDesigner/ItemParameters/ConditionSetTreeDesignerNoTypeItemParameter'));
        },
    },
    methods: {
